...
<body>
	...
	<div class="konten">
		<div class="menu">
		<ul>
		<?php foreach ($vegetarian as $veg) : ?>
		<li><a href="pilih_vege.php?id=<?php echo $veg ["id"]; ?>"><h3><?php echo $veg['nama'] ?></h3></a>
		<img src="pic\<?php echo $veg ['gambar'] ?>" width="200" height="200">
		<!-- <p><?php echo $veg ['konten'] ?></p> --></li>
		<?php endforeach ?>
		</ul>
	</div>
